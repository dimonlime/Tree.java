...
class Tree {
        ...
        if (rootNode == null) { // если корневой узел не существует
            ...
            while (true) // мы имеем внутренний выход из цикла
            {
                if (currentNode.getLeftChild() != null) {
                    if (!currentNode.getLeftChild().isVisited()) {
                        currentNode = currentNode.getLeftChild();
                        leftCount++;
                    } else if (currentNode.getRightChild() != null) {
                        if (!currentNode.getRightChild().isVisited()) {
                            currentNode = currentNode.getRightChild();
                            rightCount++;
                        }
                    } else {
                ...
                if (currentNode.getLeftChild() != null && currentNode.getRightChild() != null) {
                    if (currentNode.getRightChild().isVisited() && currentNode.getLeftChild().isVisited()) {
                        currentNode.setVisited(true);
                        if (leftCount > rightCount) {
                            countLeft++;
                        } else if (leftCount < rightCount) {
                ...
                if (rootNode.getLeftChild().getLeftChild().isVisited() && rootNode.getLeftChild().getRightChild().isVisited()) {
                    countLeft++;
                    break;
                }
            }
    ...
    public void getRightCount() {
        if (rootNode == null) { // если корневой узел не существует
            ...
            while (true) // мы имеем внутренний выход из цикла
            {
                ...
                if (rootNode.getRightChild().getRightChild().isVisited() && rootNode.getRightChild().getLeftChild().isVisited()) {
                    countRight++;
                    break;
                }
            }
    ...
    public void printLeftRight() { // метод для вывода дерева в консоль
        System.out.printf("Кол-во левых: %d, Кол-во правых: %d ", getCountLeft(), getCountRight());
    }
}
